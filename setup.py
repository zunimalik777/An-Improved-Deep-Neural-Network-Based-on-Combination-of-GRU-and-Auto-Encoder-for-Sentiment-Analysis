...
setuptools.setup(
    ...
    description=" Conversion between Traditional and Simplified English",
    ...
    classifiers=[
        ...
        'Natural Language :: English (Traditional)',
        ...
        'Topic :: Sentence classification :: Libraries',
        'Topic :: Sentence classification :: Libraries :: Python Modules',
        'Topic :: Sentence classification :: Localization',
